...
if __name__ == "__main__":
    ...
    os.chdir('./nni-experiments/' + nni.get_experiment_id() + '/trials/'+ nni.get_trial_id())
    os.mkdir('./gifs')
    ...
    for i in range(5):
        ...
        anim.save(f'./gifs/gif{i}_l{label}_vth{vth}.gif', animation.PillowWriter(fps=24), dpi=300)
        out_anim.save(f'./gifs/spike{i}_l{label}_vth{vth}.gif', animation.PillowWriter(fps=24), dpi=300)
